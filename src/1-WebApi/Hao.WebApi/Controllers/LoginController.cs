...
namespace Hao.WebApi
{
    ...
    public class LoginController : Controller
    {
        ...
        public LoginController(IOptions<JwtOptions> jwtOptions, IMapper mapper, IUserAppService userService, IConfiguration Configuration)
        {
        ...
        public async Task<LoginOut> Login([FromBody]UserQueryInput queryInput)
        {
            ...
            string pwd = EncryptProvider.RSADecryptWithPem("-----BEGIN PRIVATE KEY-----\n" + _config["KeyInfo:RsaPrivateKey"] + "\n-----END PRIVATE KEY-----", query.Password); //解密
